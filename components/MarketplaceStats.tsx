      ...
      <div className="bg-white/[0.015] border border-white/5 p-4 rounded-xl">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-data tracking-[0.12em] uppercase text-white/40 font-medium">
              In-Game Marketplace
            </span>
          </div>
          <span className="text-caption text-amber-500/60 bg-amber-500/10 px-2 py-0.5 rounded border border-amber-500/15">
            Experimental
          </span>
        </div>
        <p className="text-white/40 text-body-sm">Loading marketplace data...</p>
      </div>
    );
  }
  ...
  if (!data) {
    return (
      <div className="bg-white/[0.015] border border-white/5 p-4 rounded-xl">
        ...
        <p className="text-white/40 text-body-sm">Marketplace data not available</p>
        <p className="text-data text-white/30 mt-2">
      ...
      <div className="p-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <div className="bg-white/[0.02] border border-white/5 p-3 rounded-lg">
            <span className="text-data tracking-[0.12em] uppercase text-white/40 font-medium block mb-0.5">
              Total Listings
            </span>
        ...
        <div className="mt-3 flex items-center gap-1.5 text-data text-white/30">
