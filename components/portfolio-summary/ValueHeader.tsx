...
export function ValueHeader({
  ...
  cachedAt, onRefresh, isRefreshing,
}: ValueHeaderProps) {
              ...
              {cachedAt && (
                <div className="flex items-center gap-2 mt-1.5">
                  <span className={`font-mono text-[9px] uppercase tracking-widest ${
                    Date.now() - cachedAt.getTime() > 24 * 60 * 60 * 1000
                      ? 'text-[var(--gs-gray-2)]'
                      : 'text-[var(--gs-gray-3)]'
                  }`}>
                  ...
                  {onRefresh && (
                    <button
                      ...
                      className="text-[var(--gs-gray-3)] hover:text-[var(--gs-lime)] transition-colors disabled:opacity-30"
