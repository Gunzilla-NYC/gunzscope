...
interface InsanityBreakdownProps {
...
/**
 * Flat breakdown — always visible, no drawer toggle.
 * Shows: Valuation Sources, Profit Breakdown, Data Quality, Enrichment Progress.
 */
export function InsanityBreakdown({ data, gunPrice, enrichmentProgress, isInitializing }: InsanityBreakdownProps) {
  if (isInitializing) return null;

  const { gunValue, gunHoldings, nftFloorValueUsd, totalGunSpent, nftPnL, isEnriching, progressPct } = data;
