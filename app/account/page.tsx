      ...
      <div className="min-h-dvh bg-[var(--gs-black)] text-[var(--gs-white)]">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center py-32">
          ...
          <h1 className="text-balance font-display font-bold text-2xl sm:text-3xl uppercase mb-3">
            Connect to Manage Account
          </h1>
          <p className="text-pretty font-body text-sm text-[var(--gs-gray-4)] mb-8 max-w-md text-center">
            Connect your wallet to set up your account, track up to 5 wallets, and manage your portfolio.
          </p>
          <button
        ...
        {isLoading ? (
          ...
          <div className="space-y-6">
            ...
            <section className="bg-[var(--gs-dark-2)] border border-white/[0.06] overflow-hidden">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="flex items-center gap-1.5 font-mono text-[9px] uppercase tracking-[1.5px] text-[var(--gs-gray-3)]">
                ...
                {profile && (
                  <p className="font-mono text-[11px] text-[var(--gs-gray-3)]">
            ...
            <section className="bg-[var(--gs-dark-2)] border border-white/[0.06] overflow-hidden">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-5">
                  ...
                  <p className="font-mono text-[11px] tabular-nums text-[var(--gs-gray-3)]">
                ...
                {slotsUsed === 0 && (
                  <div className="mb-5 px-4 py-3 bg-[var(--gs-lime)]/[0.04] border border-[var(--gs-lime)]/10">
                    <p className="font-mono text-[11px] text-[var(--gs-gray-4)] leading-relaxed">
                ...
                <div className="space-y-0 mb-5">
                  {portfolioAddresses.map((pa) => (
                    ...
                    >
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        {pa.label && (
                          <span className="font-mono text-[11px] text-[var(--gs-gray-3)] truncate">
                            {pa.label}
                          </span>
                        )}
                      </div>
                      <div className="flex items-center gap-2 shrink-0">
                        <Link
                          ...
                          className="font-mono text-[10px] uppercase tracking-wider px-2.5 py-1 border border-[var(--gs-gray-1)] text-[var(--gs-gray-3)] hover:border-[var(--gs-gray-3)] hover:text-[var(--gs-white)] transition-colors"
                        >
                          View
                        </Link>
                        <button
                  ...
                  {Array.from({ length: MAX_PORTFOLIO_WALLETS - slotsUsed }).map((_, i) => (
                    ...
                    >
                      ...
                      <span className="ml-3 font-mono text-[11px] text-[var(--gs-gray-2)]">
                        + Add wallet
                      </span>
                    </button>
                  ))}
                ...
                {isAtLimit ? (
                  <div className="flex items-center gap-2 py-3">
                    ...
                    <span className="font-mono text-[11px] text-[var(--gs-warning)]">
                ...
                {slotsUsed > 0 ? (
                  <Link
                    href="/portfolio"
                    className="mt-4 flex items-center font-mono text-[10px] tracking-wide text-[var(--gs-gray-3)] hover:text-[var(--gs-lime)] transition-colors"
                  >
                    View combined portfolio {'\u2192'}
                  </Link>
                ) : (
                  <p className="mt-4 font-mono text-[10px] text-[var(--gs-gray-2)]">
            ...
            <section className="bg-[var(--gs-dark-2)] border border-white/[0.06] overflow-hidden">
              <div className="h-[2px] gradient-accent-line" />
              <div className="p-6">
                <p className="font-mono text-[9px] uppercase tracking-[1.5px] text-[var(--gs-gray-3)] mb-5">
                  Settings
                </p>

                {/* Email */}
                <div className="mb-5">
                  <label className="block font-mono text-[11px] text-[var(--gs-gray-4)] mb-2">
                    Email (Optional)
                  </label>
                  <div className="flex gap-3">
                    <input
                ...
                {profile && (
                  <div className="border-t border-white/[0.06] pt-4 space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="font-mono text-[10px] text-[var(--gs-gray-3)]">Account created</span>
                      <span className="font-mono text-[10px] text-[var(--gs-gray-4)] tabular-nums">
                        {new Date(profile.createdAt).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}
                      </span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="font-mono text-[10px] text-[var(--gs-gray-3)]">Connected wallets</span>
                      <span className="font-mono text-[10px] text-[var(--gs-gray-4)] tabular-nums">
